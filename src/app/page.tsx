...
export default function HomePage() {
  ...
  // Event tracking
  const { trackLandingEvent, trackAuthEvent } = useEventTracking({
  ...
  useEffect(() => {
    ...
    trackLandingEvent("hero_view", undefined, "hero");
  }, [trackLandingEvent]);

  // Track section visibility using IntersectionObserver
  useEffect(() => {
    const sectionRefs = [
      { ref: featuresRef, action: "features_view" as const, id: "features" },
      { ref: pricingRef, action: "pricing_view" as const, id: "pricing" },
      { ref: caseStudyRef, action: "case_study_view" as const, id: "case-study" },
    ];
        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (section && !trackedSections.has(section.id)) {
              ...
              trackLandingEvent(section.action, undefined, section.id);
            }
          }
        });
      },
  ...
  // Track form field focus (signup started)
  const handleFormFieldFocus = useCallback(() => {
    if (!formStarted) {
      setFormStarted(true);
      trackLandingEvent("signup_form_started", undefined, "hero");
      trackAuthEvent("signup_form_started", "email");
    }
  }, [formStarted, trackLandingEvent, trackAuthEvent]);
  ...
  const scrollToSignup = useCallback(() => {
    trackLandingEvent("cta_clicked", "Get Started", "hero");
    ...
    if (isMobile) {
      ...
      trackLandingEvent("signup_form_view", undefined, "hero");
    }
  }, [trackLandingEvent]);
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans overflow-x-hidden pb-20 lg:pb-0">
      ...
      <section ref={pricingRef} className="py-16 sm:py-24 lg:py-32 bg-black relative overflow-hidden">
        <FloatingElement
          delay={0}
          duration={15}
      ...
      <section ref={featuresRef} className="py-16 sm:py-24 lg:py-32 bg-gradient-to-b from-black via-gray-950/50 to-black relative overflow-hidden">
        <FloatingElement
          delay={3}
          duration={20}
      ...
      <section ref={caseStudyRef} className="py-16 sm:py-24 lg:py-32 bg-black relative overflow-hidden">
